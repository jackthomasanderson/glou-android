...
- **Offline Browsing** - Previously viewed wines are cached for offline access.
- **Push Notifications** - Enable them in settings for apogee alerts.
- **Dark Mode** - Automatically switches based on your system settings.
- **Quick Add** - Use the floating action button to record a tasting quickly.
